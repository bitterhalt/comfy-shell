...
class BarlessClockWindow(widgets.Window):
    """Large clock display for barless mode"""
...
class BarlessClockOverlay(widgets.Window):
    """Callable clock overlay (same as above but overlay)"""
...
def init_barless_clock():
    """Initialize barless clock (background layer)"""
...
def init_barless_clock_overlay():
    """Initialize barless clock overlay (overlay layer)"""
...
def toggle_barless_clock_overlay():
    """Toggle/show the barless clock overlay - for keybind use"""
